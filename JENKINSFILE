    ...
    steps {
        withCredentials([string(credentialsId: 'GitTOKEN', variable: 'GITHUB_TOKEN')]) {
			...
			echo '---- MERGE DEVELOP TO MASTER ----'
                ...
                git merge origin/develop -m "merge develop a master"
